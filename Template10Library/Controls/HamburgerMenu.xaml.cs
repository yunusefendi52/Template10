...
namespace Template10.Controls
{
    ...
    public sealed partial class HamburgerMenu : UserControl
    {
        ...
        ICommand _hamburgerCommand;
        public ICommand HamburgerCommand => _hamburgerCommand ?? (_hamburgerCommand = new Mvvm.DelegateCommand(ExecuteHamburger));
        ...
        public ICommand NavCommand => _navCommand ?? (_navCommand = new Mvvm.DelegateCommand<HamburgerButtonInfo>(ExecuteNav));
        ...
        public class InfoElement
        {
            ...
            public T GetElement<T>() where T : FrameworkElement
            {
