...
namespace Template10.Controls
{
    ...
    public sealed partial class HamburgerMenu : UserControl
    {
        ...
        //                if (value != null)
        //                {
        //                    var control = (Control)LoadedNavButtons.First(x => x.HamburgerButtonInfo == value).GetElement();
        ...
        //                VisualStateManager.GoToState(GetElement() as Control, "Indeterminate", false);
        //                VisualStateManager.GoToState(GetElement() as Control, current, false);
        //            }

        //            public FrameworkElement FrameworkElement { get; }
        //            public Button Button => GetElement() as Button;
        //            public ToggleButton ToggleButton => GetElement() as ToggleButton;
